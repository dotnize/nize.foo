            ...
            <div class="mt-4 flex w-full flex-col items-center gap-4">
                ...
                <div class="flex w-full max-w-[90ch] flex-col items-center gap-2">
                    ...
                    <div class="flex w-full justify-end">
                        <button
                            class="flex items-center gap-1 rounded-lg border border-transparent bg-gruvbox-bgS p-3 px-6 text-lg shadow-md transition-all hover:brightness-125 active:border-gruvbox-fg disabled:pointer-events-none dark:bg-gruvboxDark-bgS dark:active:border-gruvboxDark-fg"
                            onClick={sendMessage}
                            disabled={sent()}
                        >
                            {sent() && (
